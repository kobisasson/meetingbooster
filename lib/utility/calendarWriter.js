...
var  calendarWriter = function (){
    ...
    atom.beginTag = validate(tags ,C.object)(function (name) {
    ...
    atom.endTag = validate(C.object)(function () {
        atom.endNode();
        return atom;
    });

    atom.addTag = validate(tags ,C.stringOrNil,C.objectOrNil,C.object)(function (name, value, props) {
